...
In this project, I've built a **Routing Practice** app by applying the concepts I have learned till now.
...
- When the **About** link in the header is clicked, then the page  navigates to the `AboutRoute`
- When the **Contact** link in the header is clicked, then the page navigates to the `ContactRoute`
- When the **Home** link in the header is clicked, then the page navigates back to the `HomeRoute`
- When an undefined path is provided in the URL, then the page navigates to the `NotFoundRoute`
...
- `HomeRoute`  consist of "/" in the URL path
- `AboutRoute`  consist of "/about" in the URL path
- `ContactRoute`  consist of "/contact" in the URL path
- No need to use the `BrowserRouter` in `App.js` as I have already included in `index.js` file
